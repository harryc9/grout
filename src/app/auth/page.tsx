...
/**
 * Unified auth page — handles both sign-in and sign-up with
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans flex items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <h1 className="font-serif font-semibold text-2xl text-gray-900">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-11 rounded-lg border-gray-200 text-gray-700 hover:bg-gray-50"
